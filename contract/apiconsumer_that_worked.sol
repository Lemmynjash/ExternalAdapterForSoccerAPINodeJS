...
contract APIConsumer is ChainlinkClient {
    ...
    constructor() {
        ...
        oracle = 0x7dABF2b641f5590AAF245c95adcDFEF13c6B6406;
        jobId = "c327ea11a9084486a497a1f52de51efd";
    ...
    function requestGamesData() public returns (bytes32 requestId) 
    {
        ...
        request.add("playerId", "90026531"); // Chainlink nodes 1.0.0 and later support this format
